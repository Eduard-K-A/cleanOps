...
export const styles: { [k: string]: React.CSSProperties } = {
  ...
  rowBetween: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 2 },
  checkboxLabel: { fontSize: 13, color: '#374151', display: 'flex', alignItems: 'center', gap: 8 },
  checkbox: { width: 16, height: 16 },
  forgot: { fontSize: 13, color: '#2563eb', textDecoration: 'none' },
  submit: {
    marginTop: 6,
    height: 46,
    borderRadius: 10,
